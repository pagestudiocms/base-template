                ...
                {{content:entries content_type="blog_item" limit="2" paginate="botton" data-content-field="entries-loop"}}
                    <div class="post">
                        <div class="post-thumbnail">
                            <a href="/{{ slug }}"><img src="https://placehold.it/800x400" alt="Blog-post Thumbnail" class="img-responsive"></a>
                        </div>
                        <div class="post-header font-alt">
                            <h2 class="post-title"><a href="/{{ slug }}">{{ title }}</a></h2>
                            <div class="post-meta">
                                By <a href="#">{{ author }}</a>| {{ created_date format="m/d/Y" }} | 3 Comments | <a href="#">Photography, </a><a href="#">Web Design</a>
                            </div>
                        </div>
